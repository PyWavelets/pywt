...
//##FOR $DTYPE$ in (double, float):
int $DTYPE$_allocating_downsampling_convolution(const $DTYPE$* input,
                                                const_index_t N, const $DTYPE$*
                                                filter, const_index_t F,
                                                $DTYPE$* output, const_index_t
                                                step, MODE mode);
//##ENDFOR $DTYPE$
 ...
 * TODO
 * for SWT
 * int upsampled_filter_convolution(const $DTYPE$* input, const int N,
 *                                  const $DTYPE$* filter, const int F,
 *                                  $DTYPE$* output, int step, int mode);
 */
#endif
