...
cdef extern from "c/wt.h":
    ...
    cdef int double_swt_a(double input[], index_t input_len, DiscreteWavelet* wavelet,
                          double output[], index_t output_len, int level)
    cdef int double_swt_d(double input[], index_t input_len, DiscreteWavelet* wavelet,
                          double output[], index_t output_len, int level)
    ...
    cdef int float_swt_a(float input[], index_t input_len, DiscreteWavelet* wavelet,
                         float output[], index_t output_len, int level)
    cdef int float_swt_d(float input[], index_t input_len, DiscreteWavelet* wavelet,
                         float output[], index_t output_len, int level)
